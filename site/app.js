...
async function fetchData(path) {
  ...
  if (!r.ok) throw new Error(`${path} unreachable (${r.status})`);
  return r.json();
}
  ...
  footer.innerHTML = `
    <div class="footer-inner">
      <div class="footer-source">
        <span class="footer-label"><span class="footer-label-full">数据来源</span><span class="footer-label-short">来源</span></span>
